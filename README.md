...
# KERNVER 4, v130 ICARUS : so i think from my understanding, icarus is a bit different. You gotta unenroll via usb via shim then you spoof with an ip.
