...
[What Kernver and ChromeOS version do I have?](*You can find your Kernver verson by pressing, esc+refresh+power and pressing Tab its the line that reads: tpm_kernver=0x00010004, if it reads that, Then Your Kernver is 4! and for your chromeos version you just have to press, Alt+V on then signin screen and you'll see your version.)*
...
# *(You can find your Kernver verson by pressing, esc+refresh+power and pressing Tab its the line that reads: tpm_kernver=0x00010004, if it reads that, Then Your Kernver is 4! and for your chromeos version you just have to press, Alt+V on then signin screen and you'll see your version.)*
